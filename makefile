...
PEA-Projekt3: bin bin/main.o bin/Graph.o bin/GeneticAlgorithm.o bin/MainMenu.o
	$(CC) $(CFLAGS) -o PEA-Projekt3 bin/main.o bin/Graph.o bin/GeneticAlgorithm.o bin/MainMenu.o
